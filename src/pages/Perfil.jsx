    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#080808", color: "white", fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #0d0b2e 0%, #120f3a 40%, #080808 100%)", padding: isMobile ? "32px 18px 28px" : "52px 64px 44px", borderBottom: "1px solid rgba(124,58,237,0.12)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "860px", margin: "0 auto", position: "relative" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "14px", margin: 0 }}>Gestiona tu cuenta y tus boletos</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: isMobile ? "24px 18px 48px" : "40px 24px 60px" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {editandoNombre ? (
                <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "8px", flexWrap: "wrap" }}>
                  ...
                  <div style={{ display: "flex", gap: "6px" }}>
                    ...
                    <button onClick={() => setEditandoNombre(false)} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", color: "rgba(255,255,255,0.6)", cursor: "pointer", fontSize: "16px", width: "34px", height: "34px", display: "flex", alignItems: "center", justifyContent: "center" }}>×</button>
                  </div>
                </div>
              ) : (
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "5px", flexWrap: "wrap" }}>
                  ...
                  <motion.button onClick={() => setEditandoNombre(true)} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}
                    style={{ background: "none", border: "none", color: "rgba(255,255,255,0.6)", cursor: "pointer", padding: "2px", display: "flex" }}
                  >
                    <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                  </motion.button>
                </div>
              )}
              <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "13.5px", marginBottom: "14px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{user?.email}</div>
              <div style={{ display: "flex", alignItems: "center", gap: "20px", flexWrap: "wrap" }}>
                <div style={{ background: "rgba(124,58,237,0.12)", border: "1.5px solid rgba(124,58,237,0.2)", borderRadius: "10px", padding: "8px 16px" }}>
                  ...
                  <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "11.5px" }}>Boletos activos</div>
                </div>
        ...
        <div style={{ marginTop: "48px", padding: "20px", background: "rgba(239,68,68,0.04)", border: "1.5px solid rgba(239,68,68,0.15)", borderRadius: "16px" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "13px", lineHeight: 1.6, marginBottom: "14px" }}>
        ...
        {modalEliminar && (
          ...
          >
            ...
            >
              ...
              <label style={{ fontSize: "12.5px", color: "rgba(255,255,255,0.6)", display: "block", marginBottom: "6px" }}>
